...
const translations: Translations = {
  en: {
    ...
    'services.bridal.detail1': 'Professional bridal styling',
    'services.bridal.detail2': 'Long-lasting products',
    'services.bridal.detail3': 'Tropical climate resistant',
    'services.bridal.detail4': 'Touch-ups included',
    'services.events': 'Special Occasions',
    'services.eventsDesc': 'Makeup for parties, birthdays, graduations, and more.',
    'services.events.detail1': 'Celebration makeup',
    'services.events.detail2': 'Personalized looks',
    'services.events.detail3': 'Group services',
    'services.events.detail4': 'Flexible scheduling',
    'services.resort': 'Resort Appointments',
    'services.resortDesc': 'On-site makeup services at your resort or wedding venue.',
    'services.resort.detail1': 'Service at your location',
    'services.resort.detail2': 'Resort experience',
    'services.resort.detail3': 'Venue coordination',
    'services.resort.detail4': 'Transportation included',
    'services.homeStudio': 'Studio Sessions',
    'services.homeStudioDesc': 'Private makeup sessions in our Punta Cana home studio.',
    'services.homeStudio.detail1': 'Professional environment',
    'services.homeStudio.detail2': 'Perfect lighting',
    'services.homeStudio.detail3': 'Premium products',
    'services.homeStudio.detail4': 'Private sessions',
  ...
  es: {
    ...
    'services.bridal.detail1': 'Estilo profesional de novia',
    'services.bridal.detail2': 'Productos de larga duración',
    'services.bridal.detail3': 'Resistente al clima tropical',
    'services.bridal.detail4': 'Retoques incluidos',
    'services.events': 'Eventos Especiales',
    'services.eventsDesc': 'Maquillaje para fiestas, cumpleaños, graduaciones y más.',
    'services.events.detail1': 'Maquillaje de celebración',
    'services.events.detail2': 'Looks personalizados',
    'services.events.detail3': 'Servicios grupales',
    'services.events.detail4': 'Horarios flexibles',
    'services.resort': 'Servicio en Resorts',
    'services.resortDesc': 'Maquillaje a domicilio en tu resort o lugar del evento.',
    'services.resort.detail1': 'Servicio en tu ubicación',
    'services.resort.detail2': 'Experiencia en resort',
    'services.resort.detail3': 'Coordinación del lugar',
    'services.resort.detail4': 'Transporte incluido',
    'services.homeStudio': 'Estudio Privado',
    'services.homeStudioDesc': 'Sesiones de maquillaje en nuestro estudio en Punta Cana.',
    'services.homeStudio.detail1': 'Ambiente profesional',
    'services.homeStudio.detail2': 'Iluminación perfecta',
    'services.homeStudio.detail3': 'Productos premium',
    'services.homeStudio.detail4': 'Sesiones privadas',
